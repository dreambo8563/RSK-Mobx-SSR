...
/***/ function(module, exports, __webpack_require__) {
  ...
  function Html(_ref) {
    ...
    return (0, _jsx3.default)("html", {
      ...
      id: "store",
      type: "text/json"
    }, void 0, store)), (0, _jsx3.default)("body", {}, void 0, (0, _jsx3.default)("div", {
      id: "app",
...
/***/ function(module, exports, __webpack_require__) {
  ...
  var _logoSmall = __webpack_require__(53);
    ...
    (0, _createClass3.default)(Navigation, [{
      ...
      value: function render() {
        ...
        return (0, _jsx3.default)('div', {
          ...
          className: _Navigation2.default.link,
          to: '/contact'
        }, void 0, ' Contact'), (0, _jsx3.default)(_Link2.default, {
          className: _Navigation2.default.link,
          to: '/detail/88'
        }, void 0, ' Detail'), (0, _jsx3.default)('div', {
          onClick: this.jump
        }, void 0, 'jump to "/detail/gogogogo"'), (0, _jsx3.default)('span', {
...
/***/ function(module, exports, __webpack_require__) {
  ...
  var _fetch = __webpack_require__(62);
  ...
  var Home = (0, _mobxReact.observer)(_class = function (_Component) {
    ...
    (0, _createClass3.default)(Home, [{
      ...
      value: function render() {
        ...
        }, void 0, _UserInfo.userInfo.news.map(function (item) {
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                return new _promise2.default(function (resolve) {
                  !/* require.ensure */(function (require) {
                    return resolve(__webpack_require__(74).default);
                  }(__webpack_require__));
                });
...
/***/ function(module, exports, __webpack_require__) {
  ...
  var Contact = (0, _mobxReact.observer)(_class = function (_React$Component) {
    ...
    (0, _createClass3.default)(Contact, [{
      ...
      key: 'render',
      value: function render() {
        return (0, _jsx3.default)('span', {}, void 0, 'Seconds passed: ', _testModel.testInstance.timerData.secondsPassed);
      }
    }]);
    return Contact;
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                return new _promise2.default(function (resolve) {
                  !/* require.ensure */(function (require) {
                    return resolve(__webpack_require__(83).default);
                  }(__webpack_require__));
                });
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 2:
                ...
                return _context.abrupt('return', (0, _jsx3.default)(Detail, {
...
/***/ function(module, exports, __webpack_require__) {
  ...
  var _ref = (0, _jsx3.default)('form', {
    action: '/signup',
    method: 'post'
  }, void 0, (0, _jsx3.default)('label', {}, void 0, 'name: '), (0, _jsx3.default)('input', {
    name: 'name'
  }), (0, _jsx3.default)('label', {}, void 0, 'password: '), (0, _jsx3.default)('input', {
    type: 'password',
    name: 'pwd'
  ...
  var Detail = (_temp = _class = function (_Component) {
    ...
    (0, _createClass3.default)(Detail, [{
      ...
      key: 'render',
      value: function render() {
        return (0, _jsx3.default)('div', {}, void 0, 'this is the params got from path ', this.props.id, _ref);
      }
    }]);
    return Detail;
...
/***/ function(module, exports, __webpack_require__) {
  ...
  // module
  exports.push([module.id, "._1eIv{padding-left:20px;padding-right:20px}._3f9Z{margin:0 auto;padding:0 0 40px;max-width:380px}._1xSd{font-size:1.25em}._3njK{margin-bottom:15px}._2kev{display:inline-block;margin-bottom:5px;max-width:100%;font-weight:700}._2J8V{display:block;box-sizing:border-box;padding:10px 16px;width:100%;height:46px;outline:0;border:1px solid #ccc;border-radius:0;background:#fff;box-shadow:inset 0 1px 1px rgba(0,0,0,.075);color:#616161;font-size:18px;line-height:1.3333333;-webkit-transition:border-color .15s ease-in-out,-webkit-box-shadow .15s ease-in-out;transition:border-color .15s ease-in-out,box-shadow .15s ease-in-out}._2J8V:focus{border-color:#0074c2;box-shadow:inset 0 1px 1px rgba(0,0,0,.075),0 0 8px rgba(0,116,194,.6)}._2JEP{display:block;box-sizing:border-box;margin:0;padding:10px 16px;width:100%;outline:0;border:1px solid #373277;border-radius:0;background:#373277;color:#fff;text-align:center;text-decoration:none;font-size:18px;line-height:1.3333333;cursor:pointer}._2JEP:hover{background:rgba(54,50,119,.8)}._2JEP:focus{border-color:#0074c2;box-shadow:0 0 8px rgba(0,116,194,.6)}._3kH-{border-color:#3b5998;background:#3b5998}._3kH-:hover{background:#2d4373}.HjYb{border-color:#dd4b39;background:#dd4b39}.HjYb:hover{background:#c23321}._1Nc8{border-color:#55acee;background:#55acee}._1Nc8:hover{background:#2795e9}._1Xln{display:inline-block;margin:-2px 12px -2px 0;width:20px;height:20px;vertical-align:middle;fill:currentColor}._1sTg{position:relative;z-index:1;display:block;margin-bottom:15px;width:100%;color:#757575;text-align:center;font-size:80%}._1sTg:before{top:50%;left:50%;z-index:-1;margin-top:-5px;margin-left:-20px;width:40px;height:10px;background-color:#fff}._1sTg:after,._1sTg:before{position:absolute;content:''}._1sTg:after{top:49%;z-index:-2;display:block;width:100%;border-bottom:1px solid #ddd}", ""]);
